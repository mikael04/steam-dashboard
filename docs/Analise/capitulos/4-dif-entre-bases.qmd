...
Após a seleção e limpeza das duas tabelas relacionadas a informações de jogos, decidi investigar as diferenças entre as bases, para tentar entender qual seria o processo de ajuste para futura união das bases de dados.
