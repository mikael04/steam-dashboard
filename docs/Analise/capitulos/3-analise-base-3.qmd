...
Após a exclusão da segunda base de dados, decidi verificar mais uma base de dados que havia encontrado de jogos da Steam.
...
Por fim, também removi as observações que se enquadravam nas categorias que definimos como não jogos.
