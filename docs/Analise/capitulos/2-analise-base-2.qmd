...
Porém, investigando a base, notei que ela era um pouco antiga, por não possuir títulos como o "Counter-Strike: Global Offensive", os jogos mais novos da série "Battlefield", entre outros, decidi então deixá-lá de lado e partir para a análise da outra base encontrada.
