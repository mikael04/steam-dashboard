...
E aqui podemos ver que ele classificou muitos jogos como outliers, em faixas superiores à $45, portanto resolvemos tirar os jogos do primeiro e último decis. Depois de remover os 10% inferiores e superiores:

```{r, graph-price-cut}
ggplot(df_payed_games[(df_payed_games$price_original >= dec_orig[2] & df_payed_games$price_original <= dec_orig[10]),], 
